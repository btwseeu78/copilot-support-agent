...
//go:embed zcopilot_1.0.21_darwin_arm64.zst
var localEmbeddedCopilotCLI []byte

//go:embed zcopilot_1.0.21_darwin_arm64.license
...
func init() {
	embeddedcli.Setup(embeddedcli.Config{
		...
		Version: "1.0.21",
		CliHash: mustDecodeBase64("m6C+enmaBJrt7W9+09Zs75fUdHsCgscWgvGrXwC5H4s="),
	})
}
